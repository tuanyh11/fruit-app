    ...
    <div className="px-[15px]">
      <Container>
        <div className="text-center">
          <h2 className={classTitle || 'mt-[100px] mb-10 leading-[1.1] text-[30px] font-bold '}>
            {content?.title}
          </h2>
        </div>
        <div className=" grid-cols-12 grid ">
          <div className={inAbout || `col-span-12 lg:col-span-4 `}>
            <div className="max-w-full h-[380px] relative">
              <div className=" overflow-y-auto  h-full w-full lg:w-[108%] fruit-health-thumb">
                {data.map((item, i) => (
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-4 lg:ml-10 mt-[10px]">
            <img
              src="https://fruitshop.7uptheme.net/wp-content/uploads/2017/04/ruler.jpg"
              alt=""
            />
          </div>
          <div className="mt-12 md:mt-0 col-span-12 md:col-span-6 lg:col-span-4">
            <div
              className="pt-[45px] px-[50px] pb-[110px] text-center text-[#555] -ml-5 -mt-[10px] bg-no-repeat bg-[center_center] bg-[length:100%_100%]"
              style={{
